...
//	@Test
	public void test() {
		System.out.println(cronJobParserService.getCronJob("#comment ", "00 09-18 * * 1-5 /home/ramesh/bin/check-db-status", 1));
		System.out.println(cronJobParserService.getCronJob("#comment ", "30 08 10 06 * /home/ramesh/full-backup", 1));
		System.out.println(cronJobParserService.getCronJob("#comment ", "00 11,16 * * * /home/ramesh/bin/incremental-backup", 1));
		System.out.println(cronJobParserService.getCronJob("#comment ", "00 09-18 * * * /home/ramesh/bin/check-db-status", 1));
		System.out.println(cronJobParserService.getCronJob("#comment ", "*/10 * * * * /home/ramesh/check-disk-space", 1));
		System.out.println(cronJobParserService.getCronJob("#comment ", "@monthly /home/sathiya/monthly-backup", 1));
		System.out.println(cronJobParserService.getCronJob("#comment ", "@yearly /home/ramesh/centos/bin/annual-maintenance", 1));
	}
...
//	@Test
	public void testTwoCrons() throws FileNotFoundException {
		System.out.println(cronJobParserService.isEqual("40 * * * * /usr/bin/php test.php >> file.txt", "40 * * * * /usr/bin/php test1.php >> file.txt"));
		System.out.println(cronJobParserService.isEqual("40 * * * * /usr/bin/php test.php >> file.txt", "   40 * * * * /usr/bin/php test.php >> file.txt"));
	}
